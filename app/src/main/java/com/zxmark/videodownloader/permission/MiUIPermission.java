...
public class MiUIPermission extends MainPermission {
    ...
    public boolean checkContactsPermission(Context context) {
        ...
        if (version >= 23) {
            ...
            try {
                ...
                boolean isHasRead = AppOpsManager.MODE_ALLOWED == (int) method.invoke(manager, 4, Binder.getCallingUid(), context.getPackageName());
                boolean isHasWrite = AppOpsManager.MODE_ALLOWED == (int) method.invoke(manager, 5, Binder.getCallingUid(), context.getPackageName());
